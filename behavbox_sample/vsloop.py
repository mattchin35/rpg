...
from visual_stimuli.visualstim_concurrent import (
    VisualStimMultiprocess,
    VisualStimThreaded,
)
...
def repeat_stimulus_process(
    visualstim: VisualStim, stimulus_name: str, t_stimulus: float
):
